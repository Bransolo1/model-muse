  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": { "0%, 100%": { boxShadow: "0 0 20px -5px hsl(24 95% 53% / 0.3)" }, "50%": { boxShadow: "0 0 40px -5px hsl(24 95% 53% / 0.5)" } },
        shimmer: { "0%": { backgroundPosition: "-200% 0" }, "100%": { backgroundPosition: "200% 0" } },
        "grid-fade": { "0%": { opacity: "0.03" }, "50%": { opacity: "0.06" }, "100%": { opacity: "0.03" } },
      },
      animation: {
